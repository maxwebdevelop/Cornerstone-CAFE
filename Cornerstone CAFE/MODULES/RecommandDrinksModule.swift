//
//  RecommandDrinksModule.swift
//  Cornerstone CAFE
//
//  Created by Maxim Fedorets on 10/30/22.
//

import SwiftUI

class RecommandDrinksModule: ObservableObject {
    @Published var drinks: [OneDrink] = []
    ...
    OneDrink(DrinkImageName: "Tea", DrinkName: "Tea", DrinkDescription: "", DrinkIsCoffee: false, ItemIsNotDrink: false, DrinkCanBeIced: true, coldDrink: false, drinkNumber: 5, isAvailable: true),
    OneDrink(DrinkImageName: "VanillaChaiTea", DrinkName: "Vanilla Chai Tea", DrinkDescription: "Tea is blended with powdered vanilla creamer for a rich, smooth taste", DrinkIsCoffee: false, ItemIsNotDrink: false, DrinkCanBeIced: true, coldDrink: false, drinkNumber: 6, isAvailable: true),
